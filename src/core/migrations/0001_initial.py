    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Название статуса заявки', max_length=50, verbose_name='Название')),
                ('description', models.TextField(help_text='Этот текст будет отображаться клиенту при просмотре заявки', verbose_name='Описание')),
            ],
            options={
                'verbose_name': 'Статус',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, max_length=100, verbose_name='Клиент')),
